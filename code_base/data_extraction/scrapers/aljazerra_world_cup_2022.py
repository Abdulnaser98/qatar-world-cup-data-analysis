...
def remove_unwanted_links():
    ...
    unwanted_links = pd.read_csv("/Users/abdulnaser/Desktop/DHKatar/code_base/data_extraction/article_links/aljazerra_unwanted_links.csv")
...
def save_data():
    ...
    df.to_csv("aljazerra_qatar_data.csv", index=False)
